...
console.log("Latihan 1  Kalkulator Sederhana") ;
// 2. Deklarasi variabel baru menggunakan const
const panjang = 12;
const lebar = 8;

// 3. Hitung luas dan keliling persegi panjang
const luas = panjang * lebar;
const keliling = 2 * (panjang + lebar);

// 4. Tampilkan hasil menggunakan template literal (tanda backtick `)
console.log(`Luas persegi panjang: ${luas}`);
console.log(`Keliling persegi panjang: ${keliling}`);

// 5. Pengecekan apakah luas lebih besar dari 100
